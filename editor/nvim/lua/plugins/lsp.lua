	...
	},
	{
		...
		opts = function(_, opts)
			...
			opts.setup.vtsls = function(_, opts)
				...
				if
					util.root_pattern("deno.json", "deno.jsonc")(opts.root_dir or vim.uv.cwd())
					and not util.root_pattern("package.json", "package-lock.json")(opts.root_dir or vim.uv.cwd())
				then
					return true
				end
			...
			opts.setup.denols = function(_, deno_opts)
				local util = require("lspconfig.util")
				-- If we do NOT find a deno.{json,lock}, disable denols
