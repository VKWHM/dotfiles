return {
	...
	config = function()
		...
		dashboard.section.buttons.val = {
			...
			dashboard.button("LDR fr", " 🚀  Recent", "<cmd>Telescope oldfiles<CR>"),
			dashboard.button("LDR wr", " 🚩  Restore Session", "<cmd>SessionRestore<CR>"),
			dashboard.button("LDR fs", " 🔬  Find Word", "<cmd>Telescope live_grep<CR>"),
			dashboard.button("LDR qq", " 🏓  Quit NVIM", "<cmd>qa!<CR>"),
		}
