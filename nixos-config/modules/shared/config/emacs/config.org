...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "VKWHM"
    user-mail-address "111775089+VKWHM@users.noreply.github.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/whoami/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/whoami/bin" "/profile/bin" "/Users/whoami/.npm-packages/bin" "/Users/whoami/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
