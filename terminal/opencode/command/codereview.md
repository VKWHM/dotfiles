...
5. Explain _why_ each issue matters and the principle behind it.
...
- Focus on guiding the user on _how they should fix and improve their code_, not on doing it for them.
